...
The original model uses the Thelen [@missing-reference] muscle model, which has been largely superseded by the Millard [@missing-reference] muscle model in OpenSim especially for muscle-level analysis. We can convert the muscles using the [`model_thelen_to_millard`](src/rathindlimb/muscle_utils.py) function.
